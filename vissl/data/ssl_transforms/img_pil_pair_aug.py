...
@register_transform("ImgPilPairAugment")
class ImgPilPairAugment(ClassyTransform):
    ...
    def __init__(
        ...
        self.weak_transform = pth_transforms.Compose([
            pth_transforms.RandomResizedCrop((crop_size, crop_size)),
    ...
    def __call__(self, image: Image.Image) -> List:
        ...
        augmented_image = root_image.copy()
        ...
        if should_grayscale:
            grayscale = 1.0
            augmented_image = pth_transforms.RandomGrayscale(p=1.0)(augmented_image)
        ...
        if should_blur:
            ...
            augmented_image = augmented_image.filter(
            GaussianBlur(
