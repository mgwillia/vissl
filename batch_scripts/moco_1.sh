...
#SBATCH --job-name=moco_1
#SBATCH --output=outfiles/moco_1.out.%j
#SBATCH --error=outfiles/moco_1.out.%j
...
srun bash -c 'hostname; python ./tools/run_distributed_engines.py config=./pretrain/moco/moco_1node_resnet \
    ...
    config.CHECKPOINT.DIR="/vulcanscratch/mgwillia/vissl/checkpoints_moco_1" config.DATA.TRAIN.BATCHSIZE_PER_REPLICA=64'
