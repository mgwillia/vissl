...
#SBATCH --job-name=b_pirl
#SBATCH --output=outfiles/b_pirl.out.%j
#SBATCH --error=outfiles/b_pirl.out.%j
...
srun bash -c 'hostname; python ./tools/run_distributed_engines.py \
                ...
                config.MODEL.WEIGHTS_INIT.PARAMS_FILE=/vulcanscratch/mgwillia/unsupervised-classification/backbones/pirl_r50_800.torch \
                ...
                config.CHECKPOINT.DIR="/vulcanscratch/mgwillia/vissl/chkpts_b_imagenet_pirl" config.DATA.TRAIN.BATCHSIZE_PER_REPLICA=64'
