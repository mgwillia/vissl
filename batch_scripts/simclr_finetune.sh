...
srun bash -c 'hostname; CUDA_VISIBLE_DEVICES=0,1,2,3 python ./tools/run_distributed_engines.py config=./pretrain/simclr/simclr_finetune_8node_resnet \
    ...
    config.CHECKPOINT.DIR="./checkpoints_sclr_f" config.DATA.TRAIN.BATCHSIZE_PER_REPLICA=100'
