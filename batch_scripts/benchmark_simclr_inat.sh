...
#SBATCH --job-name=b_sclr_inat
#SBATCH --output=outfiles/b_sclr_inat.out.%j
#SBATCH --error=outfiles/b_sclr_inat.out.%j
...
srun bash -c 'hostname; python ./tools/run_distributed_engines.py \
                ...
                config.CHECKPOINT.DIR="/vulcanscratch/mgwillia/vissl/checkpoints_bench_sclr_inat" config.DATA.TRAIN.BATCHSIZE_PER_REPLICA=64'
