...
#SBATCH --job-name=b_bwtins
#SBATCH --output=outfiles/b_bwtins.out.%j
#SBATCH --error=outfiles/b_bwtins.out.%j
...
srun bash -c 'hostname; python ./tools/run_distributed_engines.py \
                ...
                config.CHECKPOINT.DIR="/vulcanscratch/mgwillia/vissl/checkpoints_bench_btwins" config.DATA.TRAIN.BATCHSIZE_PER_REPLICA=64'
