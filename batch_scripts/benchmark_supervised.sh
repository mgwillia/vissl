...
#SBATCH --job-name=b_sup
#SBATCH --output=outfiles/b_sup.out.%j
#SBATCH --error=outfiles/b_sup.out.%j
...
srun bash -c 'hostname; python ./tools/run_distributed_engines.py \
                ...
                config.CHECKPOINT.DIR="/vulcanscratch/mgwillia/vissl/checkpoints_bench_sup" config.DATA.TRAIN.BATCHSIZE_PER_REPLICA=64'
