...
#SBATCH --job-name=b_scnf
#SBATCH --output=outfiles/b_scnf.out.%j
#SBATCH --error=outfiles/b_scnf.out.%j
...
srun bash -c 'hostname; python ./tools/run_distributed_engines.py \
                ...
                config.MODEL.WEIGHTS_INIT.PARAMS_FILE=/vulcanscratch/mgwillia/unsupervised-classification/backbones/scanf_r50_1.torch \
                ...
                config.CHECKPOINT.DIR="/vulcanscratch/mgwillia/vissl/checkpoints_bench_scanf" config.DATA.TRAIN.BATCHSIZE_PER_REPLICA=64 \
