...
#SBATCH --output=outfiles/jigsaw_mod_lin.out.%j                            # indicates a file to redirect STDOUT to; %j is the jobid 
#SBATCH --error=outfiles/jigsaw_mod_lin.out.%j                             # indicates a file to redirect STDERR to; %j is the jobid
...
srun bash -c 'hostname; python ./tools/run_distributed_engines.py \
                ...
                config.MODEL.WEIGHTS_INIT.PARAMS_FILE=/vulcanscratch/mgwillia/vissl/checkpoints_jigsaw_modern_aug/model_final_checkpoint_phase104.torch \
                ...
                config.CHECKPOINT.DIR="/vulcanscratch/mgwillia/vissl/checkpoints_bench_jigsaw_modern_aug"'
