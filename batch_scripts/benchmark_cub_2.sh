...
#SBATCH --job-name=b_cub_2
#SBATCH --output=outfiles/b_cub_2.out.%j
#SBATCH --error=outfiles/b_cub_2.out.%j
...
CHECKPOINTS_DIRS=("chkpts_b_cub_btwins_2" "chkpts_b_cub_dc_2" "chkpts_b_cub_moco_2" "chkpts_b_cub_sclr_2" "chkpts_b_cub_simsiam_2" "chkpts_b_cub_sup_2" "chkpts_b_cub_swav_2")
