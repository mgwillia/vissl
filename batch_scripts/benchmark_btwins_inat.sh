...
#SBATCH --job-name=b_bwtins_inat
#SBATCH --output=outfiles/b_bwtins_inat.out.%j
...
srun bash -c 'hostname; python ./tools/run_distributed_engines.py \
                ...
                config.MODEL.WEIGHTS_INIT.PARAMS_FILE=/vulcanscratch/mgwillia/unsupervised-classification/backbones/btwins_r50_1000.torch \
                ...
                config.CHECKPOINT.DIR="/vulcanscratch/mgwillia/vissl/checkpoints_bench_btwins_inat" config.DATA.TRAIN.BATCHSIZE_PER_REPLICA=64'
