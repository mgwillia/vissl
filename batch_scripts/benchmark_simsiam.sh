...
#SBATCH --job-name=b_simsiam
#SBATCH --output=outfiles/b_simsiam.out.%j
#SBATCH --error=outfiles/b_simsiam.out.%j
...
srun bash -c 'hostname; python ./tools/run_distributed_engines.py \
                ...
                config.CHECKPOINT.DIR="/vulcanscratch/mgwillia/vissl/checkpoints_bench_simsiam" config.DATA.TRAIN.BATCHSIZE_PER_REPLICA=64'
